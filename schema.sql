...
ALTER TABLE public.image_attributes OWNER TO kelvin;

--
-- Name: metadata_file_info; Type: TABLE; Schema: public; Owner: kelvin
--

CREATE TABLE public.metadata_file_info (
...
ALTER TABLE public.metadata_file_info OWNER TO kelvin;

--
-- Name: min_max_pixel_value; Type: TABLE; Schema: public; Owner: kelvin
--

CREATE TABLE public.min_max_pixel_value (
    landsat_scene_id text NOT NULL,
...
ALTER TABLE public.min_max_pixel_value OWNER TO kelvin;

--
-- Name: min_max_radiance; Type: TABLE; Schema: public; Owner: kelvin
--

CREATE TABLE public.min_max_radiance (
    landsat_scene_id text NOT NULL,
...
ALTER TABLE public.min_max_radiance OWNER TO kelvin;

--
-- Name: min_max_reflectance; Type: TABLE; Schema: public; Owner: kelvin
--

CREATE TABLE public.min_max_reflectance (
    landsat_scene_id text NOT NULL,
...
ALTER TABLE public.min_max_reflectance OWNER TO kelvin;
...
ALTER TABLE public.product_metadata OWNER TO kelvin;

--
-- Name: projection_parameters; Type: TABLE; Schema: public; Owner: kelvin
--

CREATE TABLE public.projection_parameters (
    datum text,
    ellipsoid text,
...
ALTER TABLE public.projection_parameters OWNER TO kelvin;

--
-- Name: radiometric_rescaling; Type: TABLE; Schema: public; Owner: kelvin
--

CREATE TABLE public.radiometric_rescaling (
    landsat_scene_id text NOT NULL,
...
ALTER TABLE public.radiometric_rescaling OWNER TO kelvin;

--
-- Name: tirs_thermal_constants; Type: TABLE; Schema: public; Owner: kelvin
--

CREATE TABLE public.tirs_thermal_constants (
...
ALTER TABLE public.tirs_thermal_constants OWNER TO kelvin;
...
ALTER TABLE ONLY public.metadata_file_info
...
ALTER TABLE ONLY public.min_max_pixel_value
...
ALTER TABLE ONLY public.min_max_radiance
...
ALTER TABLE ONLY public.min_max_reflectance
...
ALTER TABLE ONLY public.projection_parameters
...
ALTER TABLE ONLY public.radiometric_rescaling
...
ALTER TABLE ONLY public.tirs_thermal_constants
